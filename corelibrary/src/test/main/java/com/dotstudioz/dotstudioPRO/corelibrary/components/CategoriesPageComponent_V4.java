...
public class CategoriesPageComponent_V4 implements
    ...
    private void setImageToSliderAndCenterTextExtraOne(SliderLayout sliderShow, SpotLightChannelDTO spotLightChannelDTO, String imageString, String categoryString, int index, int activeColor, int inActiveColor, int featuredTitleColour, boolean showWatchVidBut) {
        ...
        /*if(spotLightChannelDTO.isSeasonsPresent())
            ...
            categorySliderForChannel_v1.showAddToMyListButton = true;
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if(ApplicationConstants.selectedIndexOfChannelFlag) {
                    ...
                    //System.out.println("ApplicationConstants.getInstance().selectedIndexOfChannel==>" + ApplicationConstants.getInstance().selectedIndexOfChannel);
                    //System.out.println("position==>" + position);

                    adapter1.channelIdPlusCategorySlugFromMultiViewPager = "adasdasd";
            ...
            public void onPageScrollStateChanged(int state) {
                ...
                if(state == ViewPager.SCROLL_STATE_DRAGGING) {
                    ApplicationConstants.getInstance().hasScrolled = true;
                } else if(state == ViewPager.SCROLL_STATE_SETTLING) {
                    ApplicationConstants.selectedIndexOfChannelFlag = true;
                } else {
                    ApplicationConstants.selectedIndexOfChannelFlag = false;
                }
            }
        });
