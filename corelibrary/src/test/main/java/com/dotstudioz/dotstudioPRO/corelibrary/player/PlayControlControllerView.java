 ...
 * </ul>
 */
public class PlayControlControllerView extends FrameLayout {
    ...
    public PlayControlControllerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRoot = null;
        mContext = context;
        mediaPlayerControl = (MediaPlayerControl) mContext;
    ...
    public PlayControlControllerView(Context context, boolean useFastForward) {
        super(context);
        mContext = context;
        mediaPlayerControl = (MediaPlayerControl) mContext;
    ...
    public PlayControlControllerView(Context context) {
        this(context, true);
        mContext = context;
        mediaPlayerControl = (MediaPlayerControl) mContext;
        Log.i(TAG, TAG);
    ...
    public void show(int timeout) {
        if(mPlayer != null) {
            mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.ON_DISPLAY_CLICK);
            ...
            if (mediaPlayerControl.isLiveVideoSource())
                hideButtonsForLive();
            else
                showButtonsForM3U8();
        }
    ...
    private void doPauseResume() {
        ...
        if (mPlayer.isPlaying()) {
            mediaPlayerControl.analyticsPlayerCollectionVideoCollector(AnalyticsConstants.ON_PAUSE, "" + (mPlayer.getCurrentPosition()/1000), "" + (mPlayer.getCurrentPosition()/1000));
            mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.ON_PAUSE);
            mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.CATEGORY_PLAYBACK, AnalyticsConstants.EVENT_PAUSE, (mPlayer.getDuration()/1000), (mPlayer.getCurrentPosition()/1000), (mPlayer.getCurrentPosition()/1000), AnalyticsConstants.OLD_STATE_PLAYING );
            mediaPlayerControl.setIsPausedManually(true);
            mediaPlayerControl.pause();
        } else {
            mediaPlayerControl.start();
            mediaPlayerControl.analyticsPlayerCollectionVideoCollector(AnalyticsConstants.ON_RESUME, "" + (mPlayer.getCurrentPosition()/1000), "" + (mPlayer.getCurrentPosition()/1000));
            mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.ON_RESUME);
            mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.CATEGORY_PLAYBACK, AnalyticsConstants.EVENT_PLAY, (mPlayer.getDuration()/1000), (mPlayer.getCurrentPosition()/1000), (mPlayer.getCurrentPosition()/1000), AnalyticsConstants.OLD_STATE_PAUSED );
        }
        updatePausePlay();
    }
    ...
    private void doToggleFullscreen() {
        ...
        if(mediaPlayerControl.isFullScreen())
            mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.CATEGORY_PLAYER_SETUP, AnalyticsConstants.EVENT_RESIZE, (mPlayer.getDuration()/1000), (mPlayer.getCurrentPosition()/1000), (mPlayer.getCurrentPosition()/1000), "fullscreen" );
        else
            mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.CATEGORY_PLAYER_SETUP, AnalyticsConstants.EVENT_RESIZE, (mPlayer.getDuration()/1000), (mPlayer.getCurrentPosition()/1000), (mPlayer.getCurrentPosition()/1000), "restore" );
        mediaPlayerControl.analyticsPlayerCollectionVideoCollector(AnalyticsConstants.ON_FULL_SCREEN, "" + (mPlayer.getCurrentPosition()/1000), "" + (mPlayer.getCurrentPosition()/1000));
        mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.ON_FULL_SCREEN);
    }
    ...
    private OnSeekBarChangeListener mSeekListener = new OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar bar, int progress, boolean fromuser) {
            ...
            mediaPlayerControl.analyticsPlayerCollectionVideoCollector(AnalyticsConstants.ON_SEEK, "" + (newposition / 1000L), "" + progress);
            mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.ON_SEEK);
        }
        ...
        public void onStopTrackingTouch(SeekBar bar) {
            ...
            mediaPlayerControl.setSeekedManually(true);
            mediaPlayerControl.setSeekedFromAndTo(startPosition, endPosition);
            mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.CATEGORY_PLAYBACK, AnalyticsConstants.EVENT_SEEK, (mPlayer.getDuration()/1000), startPosition, endPosition, AnalyticsConstants.OLD_STATE_PLAYING );
        }
    };
    ...
    private OnClickListener mRewListener = new OnClickListener() {
        public void onClick(View v) {
            ...
            mediaPlayerControl.setSeekedManually(true);
            mediaPlayerControl.setSeekedFromAndTo(beforeSeek, endPosition);
            mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.CATEGORY_PLAYBACK, AnalyticsConstants.EVENT_SEEK, (mPlayer.getDuration()/1000), (beforeSeek/1000), (afterSeek/1000), AnalyticsConstants.OLD_STATE_PLAYING );
        }
    };
    ...
    private OnClickListener mFfwdListener = new OnClickListener() {
        public void onClick(View v) {
            ...
            mediaPlayerControl.setSeekedManually(true);
            mediaPlayerControl.setSeekedFromAndTo(beforeSeek, afterSeek);
            mediaPlayerControl.analyticsPlayerCollectionVideoCollection(AnalyticsConstants.CATEGORY_PLAYBACK, AnalyticsConstants.EVENT_SEEK, (mPlayer.getDuration()/1000), (beforeSeek/1000), (afterSeek/1000), AnalyticsConstants.OLD_STATE_PLAYING );
        }
    };
    ...
    private static class MessageHandler extends Handler {
        private final WeakReference<PlayControlControllerView> mView;

        MessageHandler(PlayControlControllerView view) {
            mView = new WeakReference<PlayControlControllerView>(view);
        }
        @Override
        public void handleMessage(Message msg) {
            PlayControlControllerView view = mView.get();
            ...
            switch (msg.what) {
                case FADE_OUT:
                    ...
                    if(!view.mediaPlayerControl.isPlaying() || view.getBufferingFlag()) {
