...
public class VideoOrChannelItemPagerWithBorderAdapter_V1 extends PagerAdapter {
    ...
    public VideoOrChannelItemPagerWithBorderAdapter_V1(Context context) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        System.out.println("Inside VideoOrChannelItemPagerWithBorderAdapter_V1!==>"+spotLightCategoriesDTO.getCategorySlug());
        System.out.println("Inside VideoOrChannelItemPagerWithBorderAdapter_V1!==>"+spotLightCategoriesDTO.getCategorySlug());
        System.out.println("Inside VideoOrChannelItemPagerWithBorderAdapter_V1!==>"+spotLightCategoriesDTO.getCategorySlug());

        if(spotLightCategoriesDTO.getSpotLightChannelDTOList().size() > 0 &&
                (spotLightCategoriesDTO.getSpotLightChannelDTOList().size() != 1 &&
                        !spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).isSeasonsPresent()) &&
                spotLightCategoriesDTO.getVideoInfoDTOList().size() == 0 &&
                !spotLightCategoriesDTO.isParentChannel()) {

            System.out.println("First Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
            System.out.println("First Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
            System.out.println("First Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
            ...
            System.out.println("Second Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
            System.out.println("Second Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
            System.out.println("Second Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
            ...
            System.out.println("Second and a Half Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
            System.out.println("Second and a Half Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
            System.out.println("Second and a Half Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
            ...
            String channelIdPlusCategorySlug = spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getId()+"|"+spotLightCategoriesDTO.getCategorySlug();
            imageView.setTag(imageView.getId(), channelIdPlusCategorySlug);

            String episodeNameWithSeriesTitle = "";
            if(spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(position).getSeriesTitle() != null && spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(position).getSeriesTitle().length() > 0) {
                episodeNameWithSeriesTitle = spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(position).getSeriesTitle();
            }
            if(episodeNameWithSeriesTitle.length() > 0)
                episodeNameWithSeriesTitle = episodeNameWithSeriesTitle + " - " + spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(position).getVideoTitle();
            else
                episodeNameWithSeriesTitle = spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(position).getVideoTitle();

            if(spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(position).getVideoPausedPoint() > 0 &&
                    spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(position).getVideoDuration() > 0) {
                int videoDuration = spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(position).getVideoDuration();
                int videoPausedPointPercentage = ((spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(position).getVideoPausedPoint() * 100)/videoDuration);
            ...
            videoTitleTV.setText(spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(position).getVideoTitle());
            actorsTV.setText(spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(position).getSeriesTitle());
            //actorsTV.setVisibility(View.GONE);
            //actorsTV.setText(videoInfoDTOArrayList.get(position).getCasting());
            ...
            System.out.println("Third Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
            System.out.println("Third Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
            System.out.println("Third Condition VideoOrChannelItemPagerWithBorderAdapter_V1!==>");
