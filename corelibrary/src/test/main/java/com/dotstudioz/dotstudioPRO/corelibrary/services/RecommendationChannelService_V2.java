 ...
 */
public class RecommendationChannelService_V2 {
    public RecommendationChannelService_V2.IRecommendationService iRecommendationService;

    public RecommendationChannelService_V2(Context ctx) {
        if (ctx instanceof RecommendationChannelService_V2.IRecommendationService)
            iRecommendationService = (RecommendationChannelService_V2.IRecommendationService) ctx;
        else
