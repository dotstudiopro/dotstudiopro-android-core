...
public class VideoOrChannelItemPagerWithBorderAdapter_V2 extends PagerAdapter {
    ...
    private int actorColour = Color.parseColor("#eeeeee");
    ...
    public VideoOrChannelItemPagerWithBorderAdapter_V2(Context context) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        actorsTV.setTextColor(actorColour);
        ...
        if(spotLightCategoriesDTO.getSpotLightChannelDTOList().size() > 0 &&
            ...
            if(spotLightCategoriesDTO.getCategorySlug().equals("hero-showcase"))
                ...
                if(channelPosterWidth > 0 && channelPosterHeight > 0)
                    ...
                    imageURL = spotLightCategoriesDTO.getSpotLightChannelDTOList().get(position).getSpotlightImage() + "/" + imageWidth + "/" + imageWidth;
            }
            ...
            if(spotLightCategoriesDTO.getVideoInfoDTOList().get(position).getVideoPausedPoint() > 0 &&
                ...
                //Celebrity Page
                itemView.findViewById(R.id.childProgressContainer).setBackgroundColor(Color.parseColor("#F3AB13"));
    ...
    public int getActorColour() {
        return actorColour;
    }

    public void setActorColour(int actorColour) {
        this.actorColour = actorColour;
    }
