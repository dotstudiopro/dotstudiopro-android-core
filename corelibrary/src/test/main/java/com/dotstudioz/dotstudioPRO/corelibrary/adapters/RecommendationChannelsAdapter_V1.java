    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(recommendedItemPairDTOList.get(position).getRecommendedItemDTO4() != null) {
            try {
                ...
                convertView.findViewById(R.id.recommendedItemIV4).setTag(convertView.findViewById(R.id.recommendedItemIV3).getId(), recommendedItemPairDTOList.get(position).getRecommendedItemDTO3().getSlug());
