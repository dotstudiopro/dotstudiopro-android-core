...
public class VideoOrChannelPosterItemPagerAdapter_V1 extends PagerAdapter {

    public IVideoOrChannelPosterItemPagerAdapter iVideoOrChannelPosterItemPagerAdapter;
    ...
    public VideoOrChannelPosterItemPagerAdapter_V1(Context context) {
        iVideoOrChannelPosterItemPagerAdapter = (IVideoOrChannelPosterItemPagerAdapter) context;
        mContext = context;
                ...
                if ((spotLightCategoriesDTO.getSpotLightChannelDTOList().get(position).getVideo() != null &&
                    ...
                    imageView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            iVideoOrChannelPosterItemPagerAdapter.channelItemClickHandler(view.getTag(view.getId()).toString());
                        }
                    });
                } else {
                    imageView.setOnClickListener(new View.OnClickListener() {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (isNextNextItemClicked) {
                            ...
                            for (int i = 0; i < spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().size(); i++) {
                                if (spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(i).getThumb().equals(tagValue)) {
                                    ...
                                    if (CommonUtils.isActuallyTabletDevice((Activity) mContext)) {
                                        iVideoOrChannelPosterItemPagerAdapter.videoItemClickHandler(categoryName, spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(i).getThumb(), position);
                                    } else {
                                        iVideoOrChannelPosterItemPagerAdapter.videoItemClickHandler(categoryName, spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(i + 2).getThumb(), position);
                                    }
                                ...
                                try {
                                    if (spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(i).getThumb() != null &&
                                        ...
                                        if (CommonUtils.isActuallyTabletDevice((Activity) mContext)) {
                                            ...
                                            iVideoOrChannelPosterItemPagerAdapter.videoItemClickHandler(categoryName, spotLightCategoriesDTO.getSpotLightChannelDTOList().get(0).getVideoInfoDTOList().get(i + 1).getThumb(), position);
                                        }
                                        isNextItemClicked = false;
                                    }
                                } catch(Exception e) {
                            ...
                            iVideoOrChannelPosterItemPagerAdapter.videoItemClickHandler(desc, clickedVideoID, position);
                        }
                    }
                });
            } catch(Exception e) {
                        ...
                        if (isNextNextItemClicked) {
                            ...
                            for (int i = 0; i < videoInfoDTOArrayList.size(); i++) {
                                if (videoInfoDTOArrayList.get(i).getThumb().equals(tagValue)) {
                                    if (CommonUtils.isActuallyTabletDevice((Activity) mContext)) {
                                        iVideoOrChannelPosterItemPagerAdapter.videoItemClickHandler(categoryName, videoInfoDTOArrayList.get(i).getThumb(), position);
                                    } else {
                                        if (videoInfoDTOArrayList.size() > (i + 2))
                                            iVideoOrChannelPosterItemPagerAdapter.videoItemClickHandler(categoryName, videoInfoDTOArrayList.get(i + 2).getThumb(), position + 1);
                                        else if (videoInfoDTOArrayList.size() > (i + 1))
                                            iVideoOrChannelPosterItemPagerAdapter.videoItemClickHandler(categoryName, videoInfoDTOArrayList.get(i + 1).getThumb(), position + 1);
                                        else
                                            iVideoOrChannelPosterItemPagerAdapter.videoItemClickHandler(categoryName, videoInfoDTOArrayList.get(i).getThumb(), position);
                                    }
                                    isNextItemClicked = false;
                                ...
                                if (videoInfoDTOArrayList.get(i).getThumb().equals(tagValue)) {
                                    if (CommonUtils.isActuallyTabletDevice((Activity) mContext)) {
                                        ...
                                        if (videoInfoDTOArrayList.size() > (i + 1))
                                            iVideoOrChannelPosterItemPagerAdapter.videoItemClickHandler(categoryName, videoInfoDTOArrayList.get(i + 1).getThumb(), position);
                                        else
                                            iVideoOrChannelPosterItemPagerAdapter.videoItemClickHandler(categoryName, videoInfoDTOArrayList.get(i).getThumb(), position);
                                    }
                                    isNextItemClicked = false;
    ...
    public interface IVideoOrChannelPosterItemPagerAdapter {
