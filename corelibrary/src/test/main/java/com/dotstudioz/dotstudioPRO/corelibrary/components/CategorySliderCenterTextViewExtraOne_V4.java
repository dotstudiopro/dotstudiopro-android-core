 ...
 */
public class CategorySliderCenterTextViewExtraOne_V4 extends BaseSliderView implements ViewPagerEx.OnPageChangeListener {
    public CategorySliderCenterTextViewExtraOne_V4(Context context) {
        super(context);
    }
    public CategorySliderCenterTextViewExtraOne_V4(Context context, CategoriesPageComponent_V4 categoriesPageComponent) {
        super(context);
