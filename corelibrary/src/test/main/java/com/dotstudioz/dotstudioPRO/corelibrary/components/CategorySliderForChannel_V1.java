 ...
 */
public class CategorySliderForChannel_V1 extends BaseSliderView implements ViewPagerEx.OnPageChangeListener {
    public CategorySliderForChannel_V1(Context context) {
        super(context);
    }
    public CategorySliderForChannel_V1(Context context, CategoriesPageComponent_V4 categoriesPageComponent) {
        super(context);
