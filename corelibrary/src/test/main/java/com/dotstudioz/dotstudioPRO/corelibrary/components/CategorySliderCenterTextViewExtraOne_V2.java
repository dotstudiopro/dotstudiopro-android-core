 ...
 */
public class CategorySliderCenterTextViewExtraOne_V2 extends BaseSliderView implements ViewPagerEx.OnPageChangeListener {
    public CategorySliderCenterTextViewExtraOne_V2(Context context) {
        super(context);
    }
    public CategorySliderCenterTextViewExtraOne_V2(Context context, CategoriesPageComponent_V3 categoriesPageComponent) {
        super(context);
