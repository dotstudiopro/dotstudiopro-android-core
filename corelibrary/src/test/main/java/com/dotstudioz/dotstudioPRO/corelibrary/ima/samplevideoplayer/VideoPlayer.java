...
public interface VideoPlayer {
    ...
    public interface PlayerCallback {
        ...
        void onBufferingEnd();
        void onPreparedCalled();
    }

    void setSeekbarColor(int seekbarColor);
    ...
    void pauseContentCalledForAdPlayback();
    void resumeContentCalledForAdPlayback();
    void hideMediaController();
    void hideMediaControllerWithoutValidation();
    void hideCC();
    void showMC();
     ...
     */
    void setVideoPath(String videoUrl, boolean mIsAdDisplayed);
    ...
    void setmFullscreenButton(boolean flag);

    void setCCShowingSetting(boolean flag);

    boolean isMediaControllerShowing();

    void initializeVideoTexturePresenture();

    void setMediaControllerIsAdPlaying(boolean flag);

    void setDoNotSetPausedManuallyFlag(boolean flag);
