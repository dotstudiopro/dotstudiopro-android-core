...
public class VideoOrChannelItemPagerAdapter extends PagerAdapter {
    ...
    public VideoOrChannelItemPagerAdapter(Context context) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        View itemView = mLayoutInflater.inflate(R.layout.video_item_frame_layout_view, container, false);
