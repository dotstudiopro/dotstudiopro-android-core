...
public class DeviceCodeActivationService {
    ...
    public DeviceCodeActivationService.IDeviceCodeActivationService iDeviceCodeActivationService;

    public DeviceCodeActivationService(Context ctx) {
        if (ctx instanceof DeviceCodeActivationService.IDeviceCodeActivationService)
            iDeviceCodeActivationService = (DeviceCodeActivationService.IDeviceCodeActivationService) ctx;
        else
