 ...
 */
public class CategoriesPageComponentNestedCategories_V1 implements CategorySliderCenterTextViewExtraOneNestedCategory_V1.ICategorySliderCenterTextViewExtraOne,
        CategorySliderForChannelNestedCategories_V1.ICategorySliderCenterTextViewExtraOneNestedCategories {

    public interface ICategoriesPageComponentNestedCategories_V1 {
    ...
    private ICategoriesPageComponentNestedCategories_V1 iCategoriesPageComponentNestedCategories_V1;
    ...
    public void seeAllChannelsClickHandlerHelper(View v) {
        if(ApplicationConstants.CURRNET_LOADED_VIEW != ApplicationConstants.CATEGORIES_VIEW)
            return;
        iCategoriesPageComponentNestedCategories_V1.seeAllChannelsClickHandlerHelper(v);
    }
    ...
    public boolean isAllCapsForRailTitle = false;
    ...
    public boolean showWatchVideoButton1 = false;
    ...
    public CategoriesPageComponentNestedCategories_V1(Activity mContext, LinearLayout mContainer) {
        ...
        if (mContext instanceof CategoriesPageComponentNestedCategories_V1.ICategoriesPageComponentNestedCategories_V1)
            iCategoriesPageComponentNestedCategories_V1 = (CategoriesPageComponentNestedCategories_V1.ICategoriesPageComponentNestedCategories_V1) mContext;
        else
    ...
    private void clickHandlerForChannelsImage(String tagSent) {
        ...
        if(ApplicationConstants.CURRNET_LOADED_VIEW != ApplicationConstants.CATEGORIES_VIEW)
            return;
        iCategoriesPageComponentNestedCategories_V1.clickHandlerForChannelsImage(tagSent);
    }
    public void clickHandlerForChannelsId(String tagSent) {
        if(ApplicationConstants.CURRNET_LOADED_VIEW != ApplicationConstants.CATEGORIES_VIEW)
            return;
        iCategoriesPageComponentNestedCategories_V1.channelItemClickHandler(tagSent);
    }

    public void onVideoImageClickedOnCategory(String descToPass, String myImageToPass, int index) {
        if(ApplicationConstants.CURRNET_LOADED_VIEW != ApplicationConstants.CATEGORIES_VIEW)
            return;
        iCategoriesPageComponentNestedCategories_V1.onSliderClickWatchButton(descToPass, myImageToPass, index);
    }
    public void addToMyListButtonClicked(String channelID) {
        System.out.println("addToMyListButtonClicked");
        /*if(ApplicationConstants.CURRNET_LOADED_VIEW != ApplicationConstants.CATEGORIES_VIEW)
            return;
        iCategoriesPageComponent_V4.addToMyListButtonClicked(channelID);*/
    }
    ...
    private FrameLayout getFrameLayout(SpotLightCategoriesDTO spotLightCategoriesDTO, VideoInfoDTO videoInfoDTO, int imageWidth, int imageHeight) {
        ...
        siv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                iCategoriesPageComponentNestedCategories_V1.onVideoImageClickedOnCategory();
            }
        });
    ...
    private void setImageToSliderAndCenterTextExtraOne(SliderLayout sliderShow, VideoInfoDTO videoInfoDTO, String imageString, String categoryString, int index, int activeColor, int inActiveColor, int featuredTitleColour, boolean showWatchVidBut) {
        CategorySliderCenterTextViewExtraOneNestedCategory_V1 categorySliderCenterTextView = new CategorySliderCenterTextViewExtraOneNestedCategory_V1(activity, this);
    ...
    private void setImageToSliderAndCenterTextExtraOne(SliderLayout sliderShow, SpotLightChannelDTO spotLightChannelDTO, String imageString,  String dimensions, String categoryString, int index, int activeColor, int inActiveColor, int featuredTitleColour, boolean showWatchVidBut, boolean showWatchVidBut1) {
        CategorySliderForChannelNestedCategories_V1 categorySliderForChannel_v1 = new CategorySliderForChannelNestedCategories_V1(activity, this);
        //imageString = "http://image.dotstudiopro.com/55c8e76397f8154b12b8c5b9";
        ...
        categorySliderForChannel_v1.categorySlug = categoryString;
        ...
        categorySliderForChannel_v1.showWatchVideoButton1 = showWatchVidBut1;
        categorySliderForChannel_v1.isLiveVideo = false;

        String imageString1 = imageString;

        if(spotLightChannelDTO.getPoster() != null && spotLightChannelDTO.getPoster().length() > 0) {
            imageString1 = spotLightChannelDTO.getPoster();
            //example of dimensions is /720/405
            if(dimensions != null && dimensions.length() > 0) {
                imageString1 = imageString1 + dimensions;
            }
        }
    ...
    public void createFeaturedSlider(SpotLightCategoriesDTO spotLightCategoriesDTO, DisplayMetrics displaymetrics) {
        ...
        if (spotLightCategoriesDTO.getVideoInfoDTOList().size() > 0) {
            ...
            for (int i = 0; i < spotLightCategoriesDTO.getSpotLightChannelDTOList().size(); i++) {
                //for (int i = 0; i < ((spotLightCategoriesDTO.getVideoInfoDTOList().size()>4)?5:spotLightCategoriesDTO.getVideoInfoDTOList().size()); i++) {
                setImageToSliderAndCenterTextExtraOne(slider1, spotLightCategoriesDTO.getSpotLightChannelDTOList().get(i), spotLightCategoriesDTO.getSpotLightChannelDTOList().get(i).getSpotlightImage() + "/" + width + "/" + imageHeight, "/" + width + "/" + imageHeight, spotLightCategoriesDTO.getCategoryName(), i, activeFeaturedSliderIndicator, featuredSliderIndicator, featuredTitleColour, showWatchVideoButton, showWatchVideoButton1);
            }
    ...
    private void createAndAddPagerToContainer(SpotLightCategoriesDTO spotLightCategoriesDTO1, int imageWidth, int imageHeight) {
        ...
        if(spotLightCategoriesDTO1.getChildrenSpotLightCategoriesDTOList().size() > 0) {
            ...
            sizeOfVideoList = spotLightCategoriesDTO1.getSpotLightChannelDTOList().size();
                ...
                spotLightCategoriesDTO1.isParentChannel()) {
            sizeOfVideoList = spotLightCategoriesDTO1.getSpotLightChannelDTOList().size();
        } else if(spotLightCategoriesDTO1.getSpotLightChannelDTOList().size() == 1 &&
                spotLightCategoriesDTO1.getVideoInfoDTOList().size() > 0 &&
                !spotLightCategoriesDTO1.isParentChannel()) {
        ...
        paramsRL.setMargins(0,10,0,0);
        paramsRL.gravity = Gravity.CENTER;
        rl.setLayoutParams(paramsRL);
        ((LinearLayout.LayoutParams)rl.getLayoutParams()).setMargins(0, 10, 0, 0);
        ...
        categoryNameTV.setAllCaps(isAllCapsForRailTitle);
