...
public class SearchSuggesterAdapter extends BaseAdapter implements Filterable {
    ...
    public List<SearchSuggesterDTO> findBooks(Context context, String bookTitle) {
        ...
        Call<Object> call1 = restClientInterface.requestGet(ApplicationConstantURL.getInstance().SEARCH_SUGGESTER_API_URL+"?q="+ Uri.encode(bookTitle)+"&token="+ApplicationConstants.xAccessToken);
            ...
            public void onResponse(Call<Object> call, retrofit2.Response<Object> response) {
                try {
                    ...
                    if (response != null && response.isSuccessful() && response.body() != null) {
                        ...
                        ApplicationConstants.searchSuggesterDTOArrayList = processSearchResult(responseBody.toString());
     ...
     * Returns a search result for the given book title.
     */
    public List<SearchSuggesterDTO> findBooks1(Context context, String bookTitle) {
        //reinitialize the variables
        ApplicationConstants.isActorsSet = false;
        ApplicationConstants.isDirectorsSet = false;
        ApplicationConstants.isTitleSet = false;
