 ...
 */
public class EpisodesListAdapter_V1 extends BaseAdapter {
    ...
    public EpisodesListAdapter_V1(Activity activity, List<EpisodeItem> episodeItemsList) {
        this.activity = activity;
        this.episodeItemsList = episodeItemsList;

        if (activity instanceof EpisodesListAdapter_V1.IEpisodesListAdapter)
            iEpisodesListAdapter = (EpisodesListAdapter_V1.IEpisodesListAdapter) activity;
        else
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = inflater.inflate(R.layout.episodes_list_item_view_v1, parent, false);
