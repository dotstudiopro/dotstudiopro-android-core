 ...
 */
public class EpisodesWithoutThumbnailsListAdapter_V1 extends BaseAdapter {
    ...
    public EpisodesWithoutThumbnailsListAdapter_V1(Activity activity, List<EpisodeItem> episodeItemsList) {
        this.activity = activity;
        this.episodeItemsList = episodeItemsList;

        if (activity instanceof EpisodesWithoutThumbnailsListAdapter_V1.IEpisodesListAdapter)
            iEpisodesListAdapter = (EpisodesWithoutThumbnailsListAdapter_V1.IEpisodesListAdapter) activity;
        else
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = inflater.inflate(R.layout.episodes_list_without_thumbnail_item_view_v1, parent, false);
        ...
        moreInfoImageView.setImageDrawable(new IconDrawable(activity, FontAwesomeIcons.fa_ellipsis_v).color(Color.parseColor(activeColor)));
        moreInfoImageView1.setImageDrawable(new IconDrawable(activity, FontAwesomeIcons.fa_ellipsis_v).color(Color.parseColor(activeColor)));
        ...
        if(CommonUtils.isActuallyTabletDevice(activity))
            episodeInfoTextView.setTextSize(18f);
        else
            episodeInfoTextView.setTextSize(16f);
        ...
        if(isCustomFontEnabledForVideoTitle)
            seasonName.setTypeface(customFontForVideoTitle);
        else
        ...
        convertView.findViewById(R.id.videoThumbnailImageView1).setVisibility(View.GONE);
