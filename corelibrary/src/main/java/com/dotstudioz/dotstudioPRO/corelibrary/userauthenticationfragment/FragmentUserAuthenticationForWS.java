 ...
 * Use the {@link FragmentUserAuthenticationForWS#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentUserAuthenticationForWS extends Fragment implements View.OnFocusChangeListener {
    ...
    public FragmentUserAuthenticationForWS() {
    ...
    public static FragmentUserAuthenticationForWS newInstance() {
        FragmentUserAuthenticationForWS fragment = new FragmentUserAuthenticationForWS();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_user_authentication_ws, container, false);
        //view.setBackgroundColor(Color.parseColor("#000000"));

        view.findViewById(R.id.usernameEditText).requestFocus();
        usernameEditText = (EditText) view.findViewById(R.id.usernameEditText);
        passwordEditText = (EditText) view.findViewById(R.id.passwordEditText);
        usernameEditText.setTypeface(FontsConstants.opensansRegularFont);
        passwordEditText.setTypeface(FontsConstants.opensansRegularFont);
        ((Button)view.findViewById(R.id.submitButton)).setTypeface(FontsConstants.opensansRegularFont);
        ((Button)view.findViewById(R.id.facebookButton)).setTypeface(FontsConstants.opensansRegularFont);
        ((Button)view.findViewById(R.id.skipButton)).setTypeface(FontsConstants.opensansRegularFont);
