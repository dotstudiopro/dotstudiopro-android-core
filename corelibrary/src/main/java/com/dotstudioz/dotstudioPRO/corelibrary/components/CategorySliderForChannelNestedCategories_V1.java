...
public class CategorySliderForChannelNestedCategories_V1 extends BaseSliderView implements ViewPagerEx.OnPageChangeListener {
    ...
    public boolean showParentSeasonOnly = false;
    ...
    public View getView() {
        ...
        ((Button) v.findViewById(R.id.showWatchVideoButtonButton)).setVisibility(View.GONE);
        ((Button) v.findViewById(R.id.showWatchVideoButtonButton1)).setVisibility(View.GONE);
        ...
        if(showWatchVideoButton1) {
            Button showWatchVideoButtonButton1 = (Button) v.findViewById(R.id.showWatchVideoButtonButton1);
            showWatchVideoButtonButton1.setVisibility(View.VISIBLE);

            ((Button) v.findViewById(R.id.showWatchVideoButtonButton)).setVisibility(View.GONE);

            showWatchVideoButtonButton1.setTag(this.videoDescription);
            //showWatchVideoButtonButton1.setOnClickListener(onVideoImageClickedOnCategory);
            showWatchVideoButtonButton1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    iCategorySliderCenterTextViewExtraOneNestedCategories.clickHandlerForChannelsId(channelID + "|" + categorySlug);
                    //target.performClick();
            ...
            showWatchVideoButtonButton1.setTag(this.channelID);

            //If there is a live video then hide the video title and change the button text to "Watch Live"
            if(isLiveVideo) {
                showWatchVideoButtonButton1.setText("Watch Live");
                videoTitleTextView.setVisibility(View.GONE);
            }
        }
        ...
        v.findViewById(R.id.showWatchVideoButtonButton1).setVisibility(View.VISIBLE);
