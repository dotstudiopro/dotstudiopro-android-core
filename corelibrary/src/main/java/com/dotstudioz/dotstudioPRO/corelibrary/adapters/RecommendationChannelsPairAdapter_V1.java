 ...
 */
public class RecommendationChannelsPairAdapter_V1 extends BaseAdapter {
    ...
    public RecommendationChannelsPairAdapter_V1(Activity activity, List<RecommendedItemPairDTO> recommendedItemPairDTOList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = inflater.inflate(R.layout.recommended_channel_pair_item_v1, parent, false);
        }
