 ...
 */
public class CategorySliderForChannelRecyclerView_V1 extends BaseSliderView implements ViewPagerEx.OnPageChangeListener {
    public CategorySliderForChannelRecyclerView_V1(Context context) {
        super(context);
    }
    public CategorySliderForChannelRecyclerView_V1(Context context, CategoriesPageRecyclerViewComponent_V1 categoriesPageComponent) {
        super(context);
