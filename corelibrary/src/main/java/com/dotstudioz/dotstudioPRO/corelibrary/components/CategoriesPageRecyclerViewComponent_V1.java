...
import com.dotstudioz.dotstudioPRO.corelibrary.adapters.CategoriesPageRecyclerViewComponentAdapter_V1;
 ...
 */
public class CategoriesPageRecyclerViewComponent_V1 implements
        CategorySliderCenterTextViewExtraOneRecyclerView_V1.ICategorySliderCenterTextViewExtraOne,
        CategorySliderForChannelRecyclerView_V1.ICategorySliderCenterTextViewExtraOne {

    public interface ICategoriesPageRecyclerViewComponent_V1 {
    ...
    private ICategoriesPageRecyclerViewComponent_V1 iCategoriesPageRecyclerViewComponent_V1;
    ...
    public void seeAllChannelsClickHandlerHelper(View v) {
        if(ApplicationConstants.CURRNET_LOADED_VIEW != ApplicationConstants.CATEGORIES_VIEW)
            return;
        iCategoriesPageRecyclerViewComponent_V1.seeAllChannelsClickHandlerHelper(v);
    }
    ...
    public CategoriesPageRecyclerViewComponent_V1(Activity mContext, LinearLayout mContainer) {
        ...
        if (mContext instanceof CategoriesPageRecyclerViewComponent_V1.ICategoriesPageRecyclerViewComponent_V1)
            iCategoriesPageRecyclerViewComponent_V1 = (CategoriesPageRecyclerViewComponent_V1.ICategoriesPageRecyclerViewComponent_V1) mContext;
        else
            throw new RuntimeException(mContext.toString()+ " must implement ICategoriesPageRecyclerViewComponent_V1");
    }

    public void clickHandlerForChannelsId(String tagSent) {
        if(ApplicationConstants.CURRNET_LOADED_VIEW != ApplicationConstants.CATEGORIES_VIEW)
            return;
        iCategoriesPageRecyclerViewComponent_V1.channelItemClickHandler(tagSent);
    }
    ...
    public void clickHandlerForChannelsImage(String tagSent) {
        ...
        if(ApplicationConstants.CURRNET_LOADED_VIEW != ApplicationConstants.CATEGORIES_VIEW)
            return;
        iCategoriesPageRecyclerViewComponent_V1.clickHandlerForChannelsImage(tagSent);
    }

    public void featuredCarouselClicked() {
        iCategoriesPageRecyclerViewComponent_V1.featuredCarouselClicked();
    }
    public void onVideoImageClickedOnCategory(String descToPass, String myImageToPass, int index) {
        if(ApplicationConstants.CURRNET_LOADED_VIEW != ApplicationConstants.CATEGORIES_VIEW)
            return;
        iCategoriesPageRecyclerViewComponent_V1.onSliderClickWatchButton(descToPass, myImageToPass, index);
    }
    public void addToMyListButtonClicked(String channelID) {
        ...
        iCategoriesPageRecyclerViewComponent_V1.addToMyListButtonClicked(channelID, selectedChannelTitle, selectedChannelSlug, selectedChannelPoster, selectedChannelSpotlightPoster);
    }
    ...
    private FrameLayout getFrameLayout(SpotLightCategoriesDTO spotLightCategoriesDTO, VideoInfoDTO videoInfoDTO, int imageWidth, int imageHeight) {
        ...
        siv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                iCategoriesPageRecyclerViewComponent_V1.onVideoImageClickedOnCategory();
            }
        });
    ...
    private void setImageToSliderAndCenterTextExtraOne(SliderLayout sliderShow, VideoInfoDTO videoInfoDTO, String imageString, String categoryString, int index, int activeColor, int inActiveColor, int featuredTitleColour, boolean showWatchVidBut, boolean doNotShowAddToMyList) {
        CategorySliderCenterTextViewExtraOneRecyclerView_V1 categorySliderCenterTextView = new CategorySliderCenterTextViewExtraOneRecyclerView_V1(activity, this);
    ...
    private void setImageToSliderAndCenterTextExtraOne(SliderLayout sliderShow, SpotLightChannelDTO spotLightChannelDTO, String imageString, String categoryString, int index, int activeColor, int inActiveColor, int featuredTitleColour, boolean showWatchVidBut) {
        CategorySliderForChannelRecyclerView_V1 categorySliderForChannel_V5 = new CategorySliderForChannelRecyclerView_V1(activity, this);
        //imageString = "http://image.dotstudiopro.com/55c8e76397f8154b12b8c5b9";
    ...
    private void createAndAddPagerToContainer(SpotLightCategoriesDTO spotLightCategoriesDTO1, int imageWidth, int imageHeight) {
        ...
        if(spotLightCategoriesDTO1.getVideoInfoDTOList().size() > 0 ||
            ...
            recyclerView.setLayoutParams(new LinearLayout.LayoutParams((genericdisplaymetrics.widthPixels+(textHeight)), (imageHeight+textHeight+(textHeight))));
        else
            recyclerView.setLayoutParams(new LinearLayout.LayoutParams((genericdisplaymetrics.widthPixels+(textHeight)), (imageHeight+(textHeight))));

        CategoriesPageRecyclerViewComponentAdapter_V1 adapter = new CategoriesPageRecyclerViewComponentAdapter_V1(activity);
        adapter.channelMyListDTOArrayList = channelMyListDTOArrayList;
        ...
        if (spotLightCategoriesDTO1.getSpotLightChannelDTOList().size() > 0 &&
            ...
            if (spotLightCategoriesDTO1.getCategorySlug().equals("hero-showcase"))
                ...
                if (channelPosterWidth > 0 && channelPosterHeight > 0) {
                    recyclerView.setLayoutParams(new LinearLayout.LayoutParams((genericdisplaymetrics.widthPixels+(textHeight)), (channelPosterHeight+(textHeight))));
                }
            }
        }

        adapter.showPoster = showPoster;
        adapter.showSpotLightImage = showSpotLightImage;
        ...
        adapter.showParentChannelOnly = showParentChannelOnly;
        ...
        viewAllTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                iCategoriesPageRecyclerViewComponent_V1.seeAllChannelsClickHandlerHelper(view);
            }
        });
    ...
    public void createPopStarHomePageHeadBlocks(ArrayList<MobileBlockDTO> appsHomeMobileBlockDTOArrayList, DisplayMetrics displaymetrics) {
        ...
        for(int i = 0; i < appsHomeMobileBlockDTOArrayList.size(); i++) {
            createAndAddBlockToContainer(appsHomeMobileBlockDTOArrayList, appsHomeMobileBlockDTOArrayList.get(i), width, imageHeight);
        }

        container.addView(CommonUtils.getInstance().getExtraSpaceView(activity, (ApplicationConstants.BOTTOM_PADDING_FOR_TAB_BAR+(ApplicationConstants.BOTTOM_PADDING_FOR_TAB_BAR*3/4))));
    }
    private void createAndAddBlockToContainer(ArrayList<MobileBlockDTO> appsHomeMobileBlockDTOArrayList, MobileBlockDTO appsHomeMobileBlockDTO, int imageWidth, int imageHeight) {
        ...
        adapter.appsHomeMobileBlockDTOArrayList = appsHomeMobileBlockDTOArrayList;
        adapter.imageHeight = imageHeight;
        adapter.imageWidth = imageWidth;
