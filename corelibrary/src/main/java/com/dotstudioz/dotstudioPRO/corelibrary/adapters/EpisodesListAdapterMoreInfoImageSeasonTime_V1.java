 ...
 */
public class EpisodesListAdapterMoreInfoImageSeasonTime_V1 extends BaseAdapter {
    ...
    public EpisodesListAdapterMoreInfoImageSeasonTime_V1(Activity activity, List<EpisodeItem> episodeItemsList) {
        this.activity = activity;
        this.episodeItemsList = episodeItemsList;

        if (activity instanceof EpisodesListAdapterMoreInfoImageSeasonTime_V1.IEpisodesListAdapter)
            iEpisodesListAdapter = (EpisodesListAdapterMoreInfoImageSeasonTime_V1.IEpisodesListAdapter) activity;
        else
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = inflater.inflate(R.layout.episodes_list_item_moreinfo_image_title_time_view_v1, parent, false);
        ...
        episodeInfoTextView.setText(episodeItem.getSeriesTitle());
        ...
        if(episodeItem.getVideoDuration() > 0) {
            episodeInfoTextView.setText(CommonCoreLibraryUtils.convertMilliToString(episodeItem.getVideoDuration() * 1000));
            episodeInfoTextView.setVisibility(View.VISIBLE);
        } else {
            episodeInfoTextView.setVisibility(View.GONE);
        }
        ...
        ((RelativeLayout.LayoutParams)convertView.findViewById(R.id.playButtonTwoColumnEpisodesListImageView).getLayoutParams()).width = imageWidth;
        ((RelativeLayout.LayoutParams)convertView.findViewById(R.id.playButtonTwoColumnEpisodesListImageView).getLayoutParams()).height = imageHeight/3;
        ((ImageView)convertView.findViewById(R.id.playButtonTwoColumnEpisodesListImageView)).setImageDrawable(new IconDrawable(activity, FontAwesomeIcons.fa_play_circle_o).color(Color.parseColor("#ffffff")));
        ...
        Log.d("EpisodesListAdapter_V1", "imageString==>"+imageString);
