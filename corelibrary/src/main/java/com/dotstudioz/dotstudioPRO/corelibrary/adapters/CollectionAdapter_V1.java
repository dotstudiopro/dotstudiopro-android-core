    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            if(spotLightCategoriesDTOListForCollection.get(position).getSpotLightCategoriesDTO2() != null &&
                    spotLightCategoriesDTOListForCollection.get(position).getSpotLightCategoriesDTO2().getCategorySlug() != null &&
                    spotLightCategoriesDTOListForCollection.get(position).getSpotLightCategoriesDTO2().getPoster() != null &&
                    spotLightCategoriesDTOListForCollection.get(position).getSpotLightCategoriesDTO2().getPoster().length() > 0) {
