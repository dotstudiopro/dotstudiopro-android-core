 ...
 */
public class EpisodesListAdapterWithoutPlayAndTwoLineTitle_V1 extends BaseAdapter {
    ...
    public EpisodesListAdapterWithoutPlayAndTwoLineTitle_V1(Activity activity, List<EpisodeItem> episodeItemsList) {
        this.activity = activity;
        this.episodeItemsList = episodeItemsList;

        if (activity instanceof EpisodesListAdapterWithoutPlayAndTwoLineTitle_V1.IEpisodesListAdapter)
            iEpisodesListAdapter = (EpisodesListAdapterWithoutPlayAndTwoLineTitle_V1.IEpisodesListAdapter) activity;
        else
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView metaInfoTextView = (TextView) convertView.findViewById(R.id.metaInfoTextView);
        ...
        metaInfoTextView.setText(episodeItem.getYearLangCountryDurationString());
