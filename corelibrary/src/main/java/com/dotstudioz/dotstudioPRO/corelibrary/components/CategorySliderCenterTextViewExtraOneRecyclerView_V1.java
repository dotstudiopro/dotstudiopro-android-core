 ...
 */
public class CategorySliderCenterTextViewExtraOneRecyclerView_V1 extends BaseSliderView implements ViewPagerEx.OnPageChangeListener {
    public CategorySliderCenterTextViewExtraOneRecyclerView_V1(Context context) {
        super(context);
    }
    public CategorySliderCenterTextViewExtraOneRecyclerView_V1(Context context, CategoriesPageRecyclerViewComponent_V1 categoriesPageComponent) {
        super(context);
    ...
    @Override
    public View getView() {
        View v = LayoutInflater.from(getContext()).inflate(R.layout.slider_render_center_text_4,null);
        ...
        v.findViewById(R.id.playButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                iCategorySliderCenterTextViewExtraOne.featuredCarouselClicked();
            }
        });
        ...
        if(showWatchVideoButton) {
            ...
            if(doNotShowAddToMyList)
                addToMyListButton.setVisibility(View.GONE);
