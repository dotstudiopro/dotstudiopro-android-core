 ...
 */
public class CategorySliderCenterTextViewExtraOneNestedCategory_V1 extends BaseSliderView implements ViewPagerEx.OnPageChangeListener {
    public CategorySliderCenterTextViewExtraOneNestedCategory_V1(Context context) {
        super(context);
    }
    public CategorySliderCenterTextViewExtraOneNestedCategory_V1(Context context, CategoriesPageComponentNestedCategories_V1 categoriesPageComponent) {
        super(context);
