 ...
 */
public class GenreAdapterWithRightArrow extends BaseAdapter {
    ...
    public GenreAdapterWithRightArrow(Activity activity, List<SpotLightCategoriesDTO> spotLightCategoriesDTOList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = inflater.inflate(R.layout.genre_item_with_right_arrow, parent, false);
        }
        ...
        try {
            ...
            ImageView viewAllIV3 = ((ImageView) convertView.findViewById(R.id.rightArrowImageView));
            viewAllIV3.getLayoutParams().height = imageHeight/5;
            viewAllIV3.getLayoutParams().width = imageHeight/5;
            viewAllIV3.setPadding(0, 0, 30, 30);
            viewAllIV3.setImageDrawable(new IconDrawable(activity, FontAwesomeIcons.fa_chevron_circle_right).color(Color.WHITE));
