 ...
 */
public class Roster2ItemsAdapter_V1 extends BaseAdapter {
    ...
    public IRoster2ItemsAdapter iRoster2ItemsAdapter;

    public Roster2ItemsAdapter_V1(Activity activity, List<SpotLightCategoriesDTOForCollection> spotLightCategoriesDTOListForCollection) {
        this.activity = activity;
        iRoster2ItemsAdapter = (IRoster2ItemsAdapter) activity;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = inflater.inflate(R.layout.roster_two_item_v1, parent, false);
        }

        try {
            ((RelativeLayout)convertView.findViewById(R.id.firstImageRelativeLayout)).getLayoutParams().width = (displayMetrics.widthPixels/2);
            ((RelativeLayout)convertView.findViewById(R.id.firstImageRelativeLayout)).getLayoutParams().height = (((displayMetrics.widthPixels/2)*9)/16);
            ...
            convertView.findViewById(R.id.iv1).setTag(convertView.findViewById(R.id.iv1).getId(), spotLightCategoriesDTOListForCollection.get(position).getSpotLightCategoriesDTO1().getCategoryName());
        ...
        try {
            if(spotLightCategoriesDTOListForCollection.get(position).getSpotLightCategoriesDTO2() != null &&
                    (spotLightCategoriesDTOListForCollection.get(position).getSpotLightCategoriesDTO2().getSpotLightChannelDTOList().size() > 0 ||
                            spotLightCategoriesDTOListForCollection.get(position).getSpotLightCategoriesDTO2().getVideoInfoDTOList().size() > 0)) {
                ...
                ((RelativeLayout) convertView.findViewById(R.id.secondImageRelativeLayout)).getLayoutParams().height = (((displayMetrics.widthPixels/2)*9)/16);
                ...
                convertView.findViewById(R.id.iv2).setTag(convertView.findViewById(R.id.iv2).getId(), spotLightCategoriesDTOListForCollection.get(position).getSpotLightCategoriesDTO2().getCategoryName());
    ...
    private void clickHandlerForChannelsImage(String tagSent) {
        iRoster2ItemsAdapter.genreImageClickHandler(tagSent);
    }

    public interface IRoster2ItemsAdapter {
