 ...
 */
public class CategorySliderCenterTextViewExtraOne_V5 extends BaseSliderView implements ViewPagerEx.OnPageChangeListener {
    public CategorySliderCenterTextViewExtraOne_V5(Context context) {
        super(context);
    }
    public CategorySliderCenterTextViewExtraOne_V5(Context context, CategoriesPageComponent_V5 categoriesPageComponent) {
        super(context);
