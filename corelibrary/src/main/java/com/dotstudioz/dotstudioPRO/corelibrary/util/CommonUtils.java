...
public class CommonUtils {
    ...
    public String getPosterURL(VideoInfoDTO videoInfoDTO, DisplayMetrics displaymetrics) {
        ...
        if (posterDataURL != null && posterDataURL.length() > 0) {
            ...
            posterDataURL = CommonUtils.replaceDotstudioproWithMyspotlightForImage(posterDataURL);
    ...
    /**
     * Expecting a rental price, such as "1.99",
     * the response will be 2
     * the logic is ==>
     * if x >= 1.5 then it becomes 2
     * if x < 1.5 then it becomes 1
     *
     * @param price ("1.99")
     * @return "2"
     */
    public String getTierFromPriceTag(String price) {
        try {
            double d = convertStringToDouble(price);
            int tierValue = (int) Math.round(d);
            StringBuilder concatenated = new StringBuilder();
            concatenated.append(tierValue);
    ...
    public void styleMediaController(View view, int color) {
        try {
            if (view instanceof MediaController) {
                ...
                try {
                    Log.d("CommonUtils", "styleMediaController non exception handler!!!");
                    ...
                    Log.d("CommonUtils", "styleMediaController exception handler!!!");
                    e.printStackTrace();
                }
            ...
            e.printStackTrace();
            Log.d("CommonUtils", "styleMediaController");
        }
    }
